...
public class Tool {
	...
	*/
	...
	public static String getShortDateTime(java.util.Date d) {
	...
	public static String getTimeString(java.util.Date d) {
		return sdf_time.format(d);
	}

	public static String getCurrentTimeString() {
		return sdf_time.format(new java.util.Date());
	}

	public static java.util.Date parseDateTime(String dt) {
		try {
	...
	public static String getLunarDay(java.util.Date date) {
		return null;
	}
